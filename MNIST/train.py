...
def train():
    ...
    model = models.LeNet_FixQ(bita = opt.bita)
    model.to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--name', default='Lenet_FixQ', help='result and weight file name')
    ...
    parser.add_argument('--bitw', type=str, default='88')
    parser.add_argument('--bita', type=str, default='54867')
