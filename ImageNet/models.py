...
class BasicBlock34(nn.Module):
    expansion = 1

    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=64, dilation=1, norm_layer=None, 
                 conv_func=None, qspace=None):
        super(BasicBlock34, self).__init__()
...
class Resnet34_MixQ(nn.Module):
    def __init__(self, num_classes=1000, block=BasicBlock34):
        super(Resnet34_MixQ, self).__init__()
        norm_layer = nn.BatchNorm2d
        ...
        conv_kwargs1 = {'kernel_size': 7, 'stride': 2, 'padding': 3, 'bias': False}
        qspace = {'abits': [1, 2, 3, 4, 5, 6, 7, 8]}
...
class Resnet34_FixQ(nn.Module):
    def __init__(self, num_classes=1000, bitw=8, bita='88888888888888888888', block=None):
        super(Resnet34_FixQ, self).__init__()
        if block is None:
            block = BasicBlock34FixQ 
        norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
        self.inplanes = 64
        self.dilation = 1
...
class BasicBlock34FixQ(nn.Module):
    expansion = 1

    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=64, dilation=1, norm_layer=None, 
                 conv_func=None, abit_iter=None, bitw=8):
        super(BasicBlock34FixQ, self).__init__()
