...
import models
from test_accResnet34 import test
...
trainset = torchvision.datasets.ImageFolder(root='/data/jli990/train', transform=transform)

def train():

    model = models.Resnet34_FixQ(bita = opt.bita)
    model.to(device)
    ...
    train_loader = torch.utils.data.DataLoader(trainset, batch_size=opt.batch_size, shuffle=True, num_workers=32, pin_memory=True)
    test_best_acc = 0.0
...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--name', default='Resnet18_FixQ', help='result and weight file name')
    parser.add_argument('-w', '--weights', default=None, help='weights path')
    parser.add_argument('-e', '--epochs', type=int, default=299) 
    ...
    parser.add_argument('--bitw', type=str, default='888888888888888888888888888888888888')
    parser.add_argument('--bita', type=str, default='888888888888888888888888888888888888')
