...
def train():
    ...
    model = models.Resnet34_MixQ(1000) 
    model.to(device)
    ...
    train_loader = torch.utils.data.DataLoader(trainset, batch_size=opt.batch_size, shuffle=True, num_workers=64, pin_memory=True)
    test_best_acc = 0.0
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='mix_resnet34_imagenet_cd3e5', help='result and weight file name')
