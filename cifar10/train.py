...
def train():
    ...
    model = models.VGG_tiny_FixQ(bita = opt.bita)
    model.to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--epochs', type=int, default=199) 
    ...
    parser.add_argument('--bitw', type=str, default='8888888')
    parser.add_argument('--bita', type=str, default='6354551')
