...
def test(model, device, batch_size = 1024, num_batch = -1):
    model.eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--model', type=str, default='Resnet_FixQ', help='model name')
    parser.add_argument('-w', '--weight', default=None, help='weights path')
    parser.add_argument('-bs', '--batch-size', type=int, default=1, help='size of each image batch')
