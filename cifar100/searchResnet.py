...
import models
from test_accResnet import test
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='mix_resnet18_cifar_cd3e5', help='result and weight file name')
    parser.add_argument('--noshare', action='store_true', help='no share weight')
    parser.add_argument('--complexity-decay', '--cd', default=3e-9, type=float, metavar='W', help='complexity decay (default: 0)')
