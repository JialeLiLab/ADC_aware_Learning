...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--epochs', type=int, default=249) 
    ...
    parser.add_argument('--bitw', type=str, default='8888888888888888888888888888888888888')
    parser.add_argument('--bita', type=str, default='8388787878474544568876663535247868525')
